            ...
            <ul>
                ...
                <li class="dropdown dropdown-mega-menu">
                    <a class="dropdown-item nav-link dropdown-toggler" href="#" data-bs-toggle="dropdown">
                        <i class="{{$category->icon }}"></i> <span>{{ $category->category_name }}</span>
                    </a>
                        ...
                        <ul class="mega-menu d-lg-flex">
                            <li class="mega-menu-col col-lg-7">
                                <ul class="d-lg-flex">
                                    ...
                                    <li class="mega-menu-col col-lg-6">
                                        <ul>
                                            <li class="dropdown-header">{{ $subcategory->subcategory_name }}</li>
                                            @foreach($subcategory->childcategories as $childcategory)
                                            <li><a class="dropdown-item nav-link nav_item" href="#">{{ $childcategory->childcategory_name }}</a></li>
                                            @endforeach
                                        </ul>
                                    </li>
                                    @endforeach
                            ...
                            <li class="mega-menu-col col-lg-5">
                                <div class="header-banner2">
                                    <img src="{{asset('/')}}frontend/assets/images/menu_banner7.jpg" alt="menu_banner">
                                ...
                                <div class="header-banner2">
                                    <img src="{{asset('/')}}frontend/assets/images/menu_banner8.jpg" alt="menu_banner">
                                    <div class="banne_info">
                                        <h6>15% Off</h6>
                                        <h4>Top Laptops</h4>
                                        <a href="#">Shop now</a>
                                     ...
                                     <div class="header_banner_content">
                                         <div class="shop_banner">
                                             <div class="banner_img overlay_bg_40">
                                                 <img src="{{asset('/')}}frontend/assets/images/shop_banner3.jpg" alt="shop_banner"/>
                                             </div>
