            ...
            <div class="container">
                ...
                <div class="mb-5">
                    <div class="row">
                        ...
                        @foreach ($top_viewed_categories->take(4) as $category)
                            ...
                            <div class="col-md-6 mb-4 mb-xl-0 col-xl-3">
                                ...
                                class="d-block text-gray-90">
                                    ...
                                    <div class="min-height-132 py-1 d-flex bg-gray-1 align-items-center">
                                        ...
                                        <!-- Category Icon -->
                                        <div class="col-6 col-xl-5 col-wd-6 pr-0 text-center">
                                        ...
                                        <div class="col-6 col-xl-7 col-wd-6">
                                            ...
                                            <div class="mb-2 pb-1 font-size-18 font-weight-light text-ls-n1 text-lh-23">
                                                ...
                                                CATCH BIG
                                                <strong>DEALS</strong>
                                                ON THE {{ strtoupper($category->category_name) }}
                            ...
                            <div class="col-md-auto mb-6 mb-md-0">
                                ...
                                <div class="p-3 border border-width-2 border-primary borders-radius-20 bg-white min-width-370">
                                        ...
                                        <div class="d-flex align-items-center flex-column justify-content-center bg-primary rounded-pill height-75 width-75 text-lh-1">
                                            ...
                                            <div class="font-size-20 font-weight-bold">
                                                ...
                                                @if($today_deal->discount_price)
                                                    {{ $setting->currency }}
                                                    {{ number_format($today_deal->selling_price - $today_deal->discount_price) }}
                                                @else
                                                    0
                                                @endif
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="mb-4">
                                            <a href="{{ route('product.details', $today_deal->product_slug) }}"
                                            class="d-block text-center">
                                                <img src="{{ asset($today_deal->thumbnail) }}"
                                                    alt="{{ $today_deal->product_name }}"
                                                    class="img-fluid"
                                                    style="width: 320px; height: 300px; object-fit: contain;">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <h5 class="mb-2 font-size-14 text-center mx-auto max-width-180 text-lh-18">
                                        ...
                                        class="text-blue font-weight-bold">
                                            ...
                                            {{ Str::limit($today_deal->product_name, 45) }}
                                    ...
                                    <div class="d-flex align-items-center justify-content-center mb-3">
                                        ...
                                        @if($today_deal->discount_price)
                                            ...
                                            <del class="font-size-18 mr-2 text-gray-2">
                                                ...
                                                {{ $setting->currency }}
                                                {{ number_format($today_deal->selling_price, 2) }}
                                            ...
                                            <ins class="font-size-30 text-red text-decoration-none">
                                                ...
                                                {{ $setting->currency }}
                                                {{ number_format($today_deal->discount_price, 2) }}
                                    ...
                                    <div class="mb-3 mx-2">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            ...
                                            <span>
                                                Available:
                                                <strong>{{ $today_deal->stock ?? 0 }}</strong>
                                            </span>

                                            <span>
                                                Already Sold:
                                                <strong>{{ $today_deal->sold ?? 0 }}</strong>
                                            </span>
                                        ...
                                        <div class="rounded-pill bg-gray-3 height-20 position-relative">
                                            ...
                                            @php
                                                $stock = $today_deal->stock ?? 0;
                                                $sold = $today_deal->sold ?? 0;

                                                $total = $stock + $sold;

                                                $soldPercent = $total > 0
                                                    ? min(100, round(($sold / $total) * 100))
                                                    : 0;
                                            @endphp

                                            <span class="position-absolute left-0 top-0 bottom-0 rounded-pill bg-primary"
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <h6 class="font-size-15 text-gray-2 text-center mb-3">
                                            Hurry Up! Offer ends in:
                                        </h6>

                                        <div class="js-countdown d-flex justify-content-center"
                                            data-end-date="{{ $today_deal->countdown_time ?? now()->addDays(2)->format('Y/m/d H:i:s') }}"
                                            data-hours-format="%H"
                                            ...
                                            <div class="text-lh-1">
                                                ...
                                                <div class="text-gray-2 font-size-12 text-center">
                                                    HOURS
                                                </div>
                                            ...
                                            <div class="mx-1 pt-1 text-gray-2 font-size-24">
                                                :
                                            </div>
                            ...
                            <ul class="row list-unstyled products-group no-gutters mb-0 overflow-visible">
                                    ...
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner p-md-3 row no-gutters">
                                            <div class="col col-lg-auto product-media-left">
                                                <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html" class="max-width-150 d-block"><img class="img-fluid" src="{{asset('/')}}frontend/assets/img/150X140/img1.jpg" alt="Image Description"></a>
                                            </div>
                                ...
                                <li class="col-wd-3 col-md-4 product-item product-item__card pb-2 mb-2 pb-md-0 mb-md-0 border-bottom border-md-bottom-0">
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner p-md-3 row no-gutters">
                                            <div class="col col-lg-auto product-media-left">
                                                <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html" class="max-width-150 d-block"><img class="img-fluid" src="{{asset('/')}}frontend/assets/img/150X140/img2.jpg" alt="Image Description"></a>
                                            </div>
                                            <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                                <div class="mb-4">
                                ...
                                <li class="col-wd-3 col-md-4 product-item product-item__card pb-2 mb-2 pb-md-0 mb-md-0 remove-divider-xl">
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner p-md-3 row no-gutters">
                                            <div class="col col-lg-auto product-media-left">
                                                <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html" class="max-width-150 d-block"><img class="img-fluid" src="{{asset('/')}}frontend/assets/img/150X140/img3.jpg" alt="Image Description"></a>
                                            </div>
                                            <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                                <div class="mb-4">
                                ...
                                <li class="col-wd-3 col-md-4 product-item product-item__card d-none d-md-block pb-2 mb-2 pb-md-0 mb-md-0 border-bottom border-md-bottom-0 remove-divider-wd">
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner p-md-3 row no-gutters">
                                            <div class="col col-lg-auto product-media-left">
                                                <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html" class="max-width-150 d-block"><img class="img-fluid" src="{{asset('/')}}frontend/assets/img/150X140/img7.jpg" alt="Image Description"></a>
                                            </div>
                                            <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                                <div class="mb-4">
                                ...
                                <li class="col-wd-3 col-md-4 product-item product-item__card d-none d-md-block pb-2 mb-2 pb-md-0 mb-md-0 border-bottom border-md-bottom-0">
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner p-md-3 row no-gutters">
                                            <div class="col col-lg-auto product-media-left">
                                                <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html" class="max-width-150 d-block"><img class="img-fluid" src="{{asset('/')}}frontend/assets/img/150X140/img4.jpg" alt="Image Description"></a>
                                            </div>
                                            <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                                <div class="mb-4">
                                ...
                                <li class="col-wd-3 col-md-4 product-item product-item__card d-none d-md-block pb-2 mb-2 pb-md-0 mb-md-0 border-bottom border-md-bottom-0 remove-divider-xl">
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner p-md-3 row no-gutters">
                                            <div class="col col-lg-auto product-media-left">
                                                <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html" class="max-width-150 d-block"><img class="img-fluid" src="{{asset('/')}}frontend/assets/img/150X140/img5.jpg" alt="Image Description"></a>
                                            </div>
                                            <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                                <div class="mb-4">
                                                    <div class="mb-2"><a href="https://transvelo.github.io/electro-html/2.0/html/shop/product-categories-7-column-full-width.html" class="font-size-12 text-gray-5">Smartwatches</a></div>
                                ...
                                <li class="col-wd-3 col-md-4 product-item product-item__card d-none d-wd-block pb-2 mb-2 pb-md-0 mb-md-0 border-bottom border-md-bottom-0">
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner p-md-3 row no-gutters">
                                            <div class="col col-lg-auto product-media-left">
                                                <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html" class="max-width-150 d-block"><img class="img-fluid" src="{{asset('/')}}frontend/assets/img/150X140/img6.jpg" alt="Image Description"></a>
                                            </div>
                                            <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                                <div class="mb-4">
                                ...
                                <li class="col-wd-3 col-md-4 product-item product-item__card d-none d-wd-block pb-2 mb-2 pb-md-0 mb-md-0 border-bottom border-md-bottom-0 remove-divider-wd">
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner p-md-3 row no-gutters">
                                            <div class="col col-lg-auto product-media-left">
                                                <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html" class="max-width-150 d-block"><img class="img-fluid" src="{{asset('/')}}frontend/assets/img/150X140/img8.jpg" alt="Image Description"></a>
                                            </div>
                                            <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                                <div class="mb-4">
